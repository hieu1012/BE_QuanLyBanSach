...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO deleteProductImages(int id, List<String> fileNames) {
        ...
        List<String> currentImages = convertJsonStringToList(product.getImages());
        
        // Xóa các file từ hệ thống và danh sách
        for (String fileName : fileNames) {
            try {
                fileUploadUtil.deleteFile("products", fileName);
        ...
        product.setImages(convertListToJsonString(currentImages));
        productRepository.save(product);
